...
check_required_files() {
  ...
  local files=(
    "$ROOT_DIR/README.md"
    "$ROOT_DIR/public/README.txt"
    "$ROOT_DIR/public/00_package_baseline.txt"
    "$ROOT_DIR/public/01_message_map.md"
    "$ROOT_DIR/public/02_launch_copy_bank.md"
    "$ROOT_DIR/public/03_demo_script_90s.md"
    "$ROOT_DIR/public/04_share_faq.md"
    "$ROOT_DIR/public/05_anchor_use_case.txt"
    "$ROOT_DIR/public/06_comparison_matrix_short.txt"
    "$ROOT_DIR/public/07_channel_playbook.md"
    "$ROOT_DIR/public/08_demo_script_30s.md"
    "$ROOT_DIR/public/09_demo_script_3min.md"
    "$ROOT_DIR/public/10_schema_release_plan.md"
    "$ROOT_DIR/public/11_faq_top5.md"
    "$ROOT_DIR/public/12_readme_repo_ready.md"
    "$ROOT_DIR/public/13_objection_memo.md"
    "$ROOT_DIR/public/14_issue_submission_packet.md"
  )
