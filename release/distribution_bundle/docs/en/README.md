...
- This repository **is** the public bundle root; it does not include `./scripts/prepare_public_bundle.sh`. If you use a wider ACP development tree, run that tree's packaging script there to copy `release/distribution_bundle/` to a publish path.
