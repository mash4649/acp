...
Evidence to show:
- `public/en/06_comparison_matrix_short.txt`
...
Evidence to show:
- `public/en/05_anchor_use_case.txt`
- `schemas/core/*`
...
Evidence to show:
- `public/en/10_schema_release_plan.md`
